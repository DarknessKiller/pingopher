...
type MockHistoryRepository struct {
	...
	GetHistoryByHostIDFunc func(ctx context.Context, hostID string, limit int) ([]*model.History, error)
}
...
func (m *MockHistoryRepository) GetHistoryByHostID(ctx context.Context, hostID string, limit int) ([]*model.History, error) {
	if m.GetHistoryByHostIDFunc != nil {
		return m.GetHistoryByHostIDFunc(ctx, hostID, limit)
	}
